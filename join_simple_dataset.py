...
def process_topology(root_path, prefix, out_path, samples_per_file, total_samples):
    ...
    iterators_lst.append((root_path,iter(api.DatanetAPI(root_path))))
    ...
    while(True):
        ...
        if (j == 0):
            ...
            res_dir = "results_%s_400-2000_%d_%d" % (prefix,i0,i1)
            i0 += samples_per_file
            i1 += samples_per_file
