...
ds_train = input_fn('../../../data/time-dist-experiments/OnOff/train', label='delay', shuffle=True)
...
ds_test = input_fn('../../../data/time-dist-experiments/OnOff/test', label='delay', shuffle=False)
