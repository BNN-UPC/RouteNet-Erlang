...
from read_dataset_old import input_fn
...
ds_train = input_fn('../../data/multiple_time_dis/train', label='delay', shuffle=True)
...
ds_test = input_fn('../../data/multiple_time_dis/test', label='delay', shuffle=False)
