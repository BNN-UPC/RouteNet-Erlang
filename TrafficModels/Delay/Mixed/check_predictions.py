...
ds_train = input_fn('../../../data/time-dist-experiments/Mixed/train', label='delay', shuffle=True)
...
ds_test = input_fn('../../../data/time-dist-experiments/Mixed/test', label='delay', shuffle=False)
