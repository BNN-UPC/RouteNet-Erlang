...
ds_train = input_fn('../../../data/time-dist-experiments/Deterministic/train', label='delay', shuffle=True)
...
ds_test = input_fn('../../../data/time-dist-experiments/Deterministic/test', label='delay', shuffle=False)
