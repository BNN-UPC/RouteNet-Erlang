...
ds_train = input_fn('../../../data/time-dist-experiments/Mixed/train', label='jitter', shuffle=True)
...
ds_test = input_fn('../../../data/time-dist-experiments/Mixed/test', label='jitter', shuffle=False)
