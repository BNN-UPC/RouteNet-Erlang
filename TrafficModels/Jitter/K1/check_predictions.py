...
ds_train = input_fn('../../../data/time-dist-experiments/k1/train', label='jitter', shuffle=True)
...
ds_test = input_fn('../../../data/time-dist-experiments/k1/test', label='jitter', shuffle=False)
