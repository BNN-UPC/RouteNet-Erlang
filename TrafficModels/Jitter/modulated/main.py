...
ds_train = input_fn('../../../data/traffic_models/modulated/train', label='jitter', shuffle=True)
ds_train = ds_train.map(lambda x, y: transformation(x, y))
ds_train = ds_train.prefetch(tf.data.experimental.AUTOTUNE)
ds_train = ds_train.repeat()

ds_test = input_fn('../../../data/traffic_models/modulated/test', label='jitter', shuffle=False)
