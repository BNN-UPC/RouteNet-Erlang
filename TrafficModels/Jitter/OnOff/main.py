...
ds_train = input_fn('../../../data/time-dist-experiments/OnOff/train', label='jitter', shuffle=True)
...
ds_test = input_fn('../../../data/time-dist-experiments/OnOff/test', label='jitter', shuffle=False)
