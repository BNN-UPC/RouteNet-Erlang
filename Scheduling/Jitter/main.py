...
ds_train = input_fn('../../data/gnnet_data_set_training', label='Jitter', shuffle=True)
...
ds_test = input_fn('../../data/gnnet_data_set_evaluation_delays', label='Jitter', shuffle=False)
