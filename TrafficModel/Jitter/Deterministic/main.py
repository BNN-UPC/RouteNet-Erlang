...
ds_train = input_fn('../../../data/time-dist-experiments/Deterministic/train', label='jitter', shuffle=True)
...
ds_test = input_fn('../../../data/time-dist-experiments/Deterministic/test', label='jitter', shuffle=False)
